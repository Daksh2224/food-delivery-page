      ...
      <div className="container">
        <nav>
          ...
          <div className='menu_container'>
            <ul>
              <li>
                <a href="www.google.com" className="active">Home</a>
              </li>
              <li>
                <a href="www.google.com" className="active">About Us</a>
              </li>
              <li>
                <a href="www.google.com" className="active">Review</a>
              </li>
              <li>
                <a href="www.google.com" className="active">Blog</a>
              </li>
            </ul>
          </div>
          ...
          <div className='button_container'>
            <ul>
              <li>
                <a href='www.google.com' className="btn">Sign In</a>
              </li>
            </ul>
